...
public static class CliCommandCatalog
{
    ...
    [
        ...
        new("installs show", typeof(InstallsShowSettings)),
        new("installs set", typeof(InstallsSetSettings)),
        new("installs delete", typeof(InstallsDeleteSettings)),
        new("steam", typeof(SteamStatusSettings)),
        new("steam status", typeof(SteamStatusSettings)),
        new("steam login", typeof(SteamLoginSettings)),
        new("steam logout", typeof(SteamLogoutSettings)),
        new("steam download", typeof(SteamDownloadSettings)),
        new("settings", typeof(LauncherSettingsSettings)),
        new("settings set", typeof(LauncherSettingsSetSettings)),
        new("open", typeof(OpenSettings)),
        new("news", typeof(NewsSettings)),
